...
class FileUploader:
    ...
    def write_to_excel(self):
        ...
        for result in self.results:
            ...
            row['Port of Loading'] = data.get('port_of_loading', '')
            row['Port of Loading Raw'] = data.get('port_of_loading_raw_text', '')
            row['Port of Discharge'] = data.get('port_of_discharge', '')
            row['Port of Discharge Raw'] = data.get('port_of_discharge_raw_text', '')
            row['Place of Receipt'] = data.get('place_of_receipt', '')
            row['Place of Delivery'] = data.get('place_of_delivery', '')
            row['Final Destination'] = data.get('final_destination', '')
            row['ETD'] = data.get('etd', '')
            row['Freight Status'] = data.get('freight_status', '')
